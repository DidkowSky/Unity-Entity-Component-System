...
namespace Assets.Scripts.DOTS
{
    ...
    public class BulletSystem : JobComponentSystem
    {
        ...
        struct SpawnBulletJob : IJobForEachWithEntity<Bullet, Position>
        {
            public EntityCommandBuffer.Concurrent CommandBuffer;

            public void Execute(Entity entity, int index, [ReadOnly] ref Bullet bullet, [ReadOnly] ref Position position)
            {
